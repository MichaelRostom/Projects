...
for i in range(1000) :
    ...
    sleep(0.1)
    driver.find_element_by_xpath(
        '/html/body/div/div[2]/form/div/div/div[2]/div[1]/div/div[2]/div[2]/div[3]/span').click()  # clicks the first option

    driver.find_element_by_xpath(
        '/html/body/div/div[2]/form/div/div/div[2]/div[2]/div/div[2]/div[1]/div[1]/div[1]/span').click()
    sleep(0.1)
    driver.find_element_by_xpath(
        '/html/body/div/div[2]/form/div/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/span').click()

    driver.find_element_by_xpath(
        '/html/body/div/div[2]/form/div/div/div[2]/div[3]/div/div[2]/div[1]/div[1]/div[1]/span').click()
    sleep(0.1)
    driver.find_element_by_xpath('/html/body/div/div[2]/form/div/div/div[2]/div[3]/div/div[2]/div[2]/div[3]').click()

    driver.find_element_by_xpath(
        '/html/body/div/div[2]/form/div/div/div[2]/div[4]/div/div[2]/div[1]/div[1]/div[1]/span').click()
    sleep(0.1)
    driver.find_element_by_xpath('/html/body/div/div[2]/form/div/div/div[2]/div[4]/div/div[2]/div[2]/div[4]').click()
